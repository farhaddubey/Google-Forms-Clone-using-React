...
function QuestionForm (){
  ...
  useEffect(()=>{
    async function data_adding(){
      ...
      var doc_desc=request.data.document_desc;
 ...
 <AccordionDetails className='add_question'>
  ...
  <div>
    <div className='add_question_top'>
      ...
      <input type='number' className='points' placeholder='0' min='0' step='1' onChange={(e) =>{setOptionPoints(e.target.value, i)}}/>
    </div>
    {ques.options.map((op, j)=>(
    ...
    <div className='add_question_bottom'>
      <Button variant='outlined' color='primary' style={{textTransform:'none', color:'#4285f4', fontSize:'12px', fontWeight:'600'}} onClick={()=>{doneAnswer(i)}}>
        Done
      </Button>
    </div>
  </div>
        ...
        <div className='section'>
                          <div className='question_title_section'>
                              <div className='question_form_top'>
                                  ...
                                  onChange={(e)=>{setDocDesc(e.target.value)}}></input>
                              </div>
                          </div>
                  ...
                  ref={provided.innerRef}>
                    ...
                    {provided.placeholder}
                        ...
                        <div className='save_form'>
                          <Button variant='contained' onClick='primary' 
                          // onClick={commitToDB} 
